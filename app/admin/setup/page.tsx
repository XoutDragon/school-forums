    ...
    <main className="min-h-screen flex items-center justify-center bg-bg px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-xl font-semibold text-text">Welcome to Campus Hub</h1>
        ...
        <form onSubmit={handleSubmit} className="bg-panel border border-border rounded-xl p-6 space-y-4">
          <div>
            <label className="block text-xs font-medium text-muted mb-1.5">Institution name</label>
            <input
              required
          ...
          <div>
            <label className="block text-xs font-medium text-muted mb-1.5">Master admin password</label>
            <input
              required
              type="password"
              value={password}
