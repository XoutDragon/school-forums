  ...
  return (
    <main className="min-h-screen bg-background px-4 py-12">
      <div className="max-w-lg mx-auto">
        <h1 className="text-xl font-semibold text-foreground mb-1">Create a topic</h1>
        ...
        <form onSubmit={handleSubmit} className="bg-card border border-border rounded-xl p-6 space-y-4">
          <div>
            <label className="block text-xs font-medium text-muted-foreground mb-1.5">Topic name</label>
            <input
              required
              value={name}
