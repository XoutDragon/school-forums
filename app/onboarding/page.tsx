  ...
  return (
    <main className="min-h-screen bg-bg px-4 py-12">
      <div className="max-w-2xl mx-auto">
        <h1 className="text-2xl font-semibold text-text mb-1">What are you into?</h1>
        <p className="text-sm text-muted mb-8">
          Pick a few classes, clubs, and interests. We'll use these to recommend topics — you can
          change this anytime.
        </p>

        {interests === undefined && <p className="text-sm text-muted">Loading interests...</p>}
